...
#define CORR_WRITE_MEMORY_BASE (CORR_BASE_ADDR + 4*0xC0)
#define CORR_READ_MEMORY_BASE  (CORR_BASE_ADDR + 4*0xD0)
...
#define CORR_NEW_DATA              (*(volatile unsigned int *)(CORR_BASE_ADDR + 4*0xE1))
