...
signal2 = longSignal(10*samplesPerCode+1 : 2*10*samplesPerCode);
...
numberOfFrqBins = 10*round(settings.acqSearchBand * 2) + 1;

// Generate all C/A codes and sample them according to the sampling freq.
caCodesTable = makeCaTable(settings);

//0000110101 - explain this magic number;
caCodesTable = [caCodesTable*-1 caCodesTable*-1 caCodesTable*-1 ...
                caCodesTable*-1 caCodesTable*1 caCodesTable*1 ...
                caCodesTable*-1 caCodesTable*1 caCodesTable*-1 ...
                caCodesTable*1];
...
// Fine resolution frequency search =======================================
        ...
        //fftNumPts = 0.5*(2^(nextpow2(length(xCarrier))));
        fftNumPts = 2*(2^(nextpow2(length(xCarrier))));
