...
#define N_CHANNELS    12 /* Number of correltor channels. */
...
#define SAMP_RATE  (double)16.0000e6     /* sampling rate.                        */
#define SYSTEM_CLOCK_MULTIPLIER (double)5/* this constant shows the relation between sampling
                                            frequency and system clock frequency. This is
                                            used to simulate HADWARE RECEIVERS! FOR
                                            PURE SOFTWARE RECEIVER IT SHOULD BE 1.*/
#define GPS_CARRIER_IF (double)2.4200e6  /* carrier Intermediate Frequency for GPS signals            */
#define GPS_CODE_F 1023000               /* PRN generator nominal clock frequency for GPS signals     */
#define GLONASS_CARRIER_IF (double)0.0e6 /* carrier Intermediate Frequency for GLONASS signals        */
...
int acq_thresh = 1800;     /* Acquisition threshold. */

/* for Integer GP2021 emulation use 32 bits */
double Carrier_DCO_Delta;  /* frequency resolution for carrier NCO.    */
double Code_DCO_Delta;     /* frequency resolution for code-clock NCO. */
...
double freq_bin_width = 1000; /* Doppler bin width in Hz. */
...
double FLL_a_PLL_k1;       /* FLL-assisted-PLL loop filter first coefficient. Perfect theoretical value for loops with unity gain NCOs.  */
double FLL_a_PLL_k2;       /* FLL-assisted-PLL loop filter second coefficient. Perfect theoretical value for loops with unity gain NCOs. */
double FLL_a_PLL_k3;       /* FLL-assisted-PLL loop filter third coefficient. Perfect theoretical value for loops with unity gain NCOs.  */
double DLL_k1;             /* DLL loop filter first coefficient. Perfect theoretical value for loops with unity gain NCOs.               */
double DLL_k2;             /* DLL loop filter second coefficient. Perfect theoretical value for loops with unity gain NCOs.              */
...
extern double Carrier_DCO_Delta;  /* frequency resolution for carrier NCO.    */
extern double Code_DCO_Delta;     /* frequency resolution for code-clock NCO. */
...
extern double freq_bin_width;     /* Doppler bin width in Hz. */
...
extern double FLL_a_PLL_k1;       /* FLL-assisted-PLL loop filter first coefficient. Perfect theoretical value for loops with unity gain NCOs.  */
extern double FLL_a_PLL_k2;       /* FLL-assisted-PLL loop filter second coefficient. Perfect theoretical value for loops with unity gain NCOs. */
extern double FLL_a_PLL_k3;       /* FLL-assisted-PLL loop filter third coefficient. Perfect theoretical value for loops with unity gain NCOs.  */
extern double DLL_k1;             /* DLL loop filter first coefficient. Perfect theoretical value for loops with unity gain NCOs.               */
extern double DLL_k2;             /* DLL loop filter second coefficient. Perfect theoretical value for loops with unity gain NCOs.              */
