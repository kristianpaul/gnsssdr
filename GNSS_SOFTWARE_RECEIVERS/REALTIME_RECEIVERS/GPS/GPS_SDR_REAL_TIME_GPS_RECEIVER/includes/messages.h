...
typedef struct Channel_M
{
	...
	int32 l2_Mode;	 	//!< L2 Channel Flag
	int32 l2_len;		//!< L2 Accumlation length 
	int32 l2_cn0;		//!< CN0 of L2 Signal
	int32 l2_p_avg;		//!< Filtered version of L2 I^2+Q^2
	int32 l2_bit_lock;	//!< CNAV Bitlock Flag
	int32 l2_frame_lock;	//!< CNAV frame lock flag
	int32 l2_count;		//!< L2 Accumulations processed
