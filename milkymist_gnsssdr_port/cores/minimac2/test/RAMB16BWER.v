// $Header: /devl/xcs/repo/env/Databases/CAEInterfaces/verunilibs/data/sandia/RAMB16BWER.v,v 1.32 2010/11/04 20:54:08 wloo Exp $
///////////////////////////////////////////////////////////////////////////////
...
//    09/21/10 - Updated address overlap for read first mode (CR 566026).
...
module RAMB16BWER (DOA, DOB, DOPA, DOPB, 
    ...
    wire [13:0] ox_addra_reconstruct, ox_addrb_reconstruct;
    reg [13:0] 	ox_addra_reconstruct_reg, ox_addrb_reconstruct_reg;
    ...
    assign ox_addra_reconstruct[13:0] = (SIM_DEVICE == "SPARTAN6" && (WRITE_MODE_A == "READ_FIRST" || WRITE_MODE_B == "READ_FIRST")) ? 
    ...
    assign ox_addrb_reconstruct[13:0] = (SIM_DEVICE == "SPARTAN6" && (WRITE_MODE_A == "READ_FIRST" || WRITE_MODE_B == "READ_FIRST")) ? 
    ...
    reg [15:0] addrawraddr_reg, addrbrdaddr_reg;
	  ...
	  if (SIM_COLLISION_CHECK != "NONE") begin
		...
		if (viol_time != 0) begin
		  ...
		  if (SIM_DEVICE == "SPARTAN3ADSP") begin
		    ...
		    end // if (!rising_clkawrclk && rising_clkbrdclk)
			...
			if (addrawraddr_in[13:col_addr_lsb] === addrbrdaddr_in[13:col_addr_lsb]) begin
			    ...
			    viol_type = 2'b01;
			    chk_col_same_clk = 1; //may not needed
			    ...
			    task_col_wr_ram_a (2'b00, webweu_int, weawel_int, di_x, di_x[7:0], addrbrdaddr_in, addrawraddr_in);
			    task_col_wr_ram_b (2'b00, weawel_int, webweu_int, di_x, di_x[7:0], addrawraddr_in, addrbrdaddr_in);
			    chk_col_same_clk = 0; //may not needed
			...
			else if ((wr_mode_a == 2'b01 || wr_mode_b == 2'b01) && (ox_addra_reconstruct[13:col_addr_lsb] === ox_addrb_reconstruct[13:col_addr_lsb])) begin
			    ...
			    task_ox_wr_ram_a (2'b10, webweu_int, weawel_int, diadi_int, dipadip_int, addrbrdaddr_in, addrawraddr_in);
			    task_ox_wr_ram_b (2'b10, weawel_int, webweu_int, dibdi_int, dipbdip_int, addrawraddr_in, addrbrdaddr_in);
			    
			    if (wr_mode_a != 2'b01)
				task_col_rd_ram_a (2'b11, webweu_int, weawel_int, addrawraddr_in, doado_buf, dopadop_buf);
			    if (wr_mode_b != 2'b01)
				task_col_rd_ram_b (2'b11, weawel_int, webweu_int, addrbrdaddr_in, dobdo_buf, dopbdop_buf);
			end // if ((wr_mode_a == 2'b01 || wr_mode_b == 2'b01) && (ox_addra_reconstruct[13:col_addr_lsb] === ox_addrb_reconstruct[13:col_addr_lsb]))
			else
				viol_time = 0;
			...
			if (addrawraddr_in[13:col_addr_lsb] === addrbrdaddr_reg[13:col_addr_lsb]) begin
			...
			else if ((wr_mode_a == 2'b01 || wr_mode_b == 2'b01) && (ox_addra_reconstruct[13:col_addr_lsb] === ox_addrb_reconstruct_reg[13:col_addr_lsb])) begin
			    ...
			    task_ox_wr_ram_a (2'b10, webweu_reg, weawel_int, diadi_int, dipadip_int, addrbrdaddr_reg, addrawraddr_in);
			    task_ox_wr_ram_b (2'b10, weawel_int, webweu_reg, dibdi_reg, dipbdip_reg, addrawraddr_in, addrbrdaddr_reg);
			    ...
			    task_col_wr_ram_a (2'b10, webweu_reg, 4'hf, di_x, di_x[7:0], addrbrdaddr_reg, addrawraddr_in);
			    task_col_wr_ram_b (2'b10, weawel_int, 8'hff, di_x, di_x[7:0], addrawraddr_in, addrbrdaddr_reg);
			
			end // if ((wr_mode_a == 2'b01 || wr_mode_b == 2'b01) && (ox_addra_reconstruct[13:col_addr_lsb] === ox_addrb_reconstruct_reg[13:col_addr_lsb]))
			else
			    viol_time = 0;
			...
			if (addrawraddr_reg[13:col_addr_lsb] === addrbrdaddr_in[13:col_addr_lsb]) begin
			...
			else if  ((wr_mode_a == 2'b01 || wr_mode_b == 2'b01) && (ox_addra_reconstruct_reg[13:col_addr_lsb] === ox_addrb_reconstruct[13:col_addr_lsb])) begin
			    ...
			    task_ox_wr_ram_a (2'b10, webweu_int, weawel_reg, diadi_reg, dipadip_reg, addrbrdaddr_in, addrawraddr_reg);
			    task_ox_wr_ram_b (2'b10, weawel_reg, webweu_int, dibdi_int, dipbdip_int, addrawraddr_reg, addrbrdaddr_in);
			    ...
			    task_col_wr_ram_a (2'b10, webweu_int, 4'hf, di_x, di_x[7:0], addrbrdaddr_in, addrawraddr_reg);
			    task_col_wr_ram_b (2'b10, weawel_reg, 8'hff, di_x, di_x[7:0], addrawraddr_reg, addrbrdaddr_in);
			    
			end // if ((wr_mode_a == 2'b01 || wr_mode_b == 2'b01) && (ox_addra_reconstruct_reg[13:col_addr_lsb] === ox_addrb_reconstruct[13:col_addr_lsb]))
			else
			    viol_time = 0;
...
/******************************************** task and function **************************************/
	...
	input [7:0] ox_wr_ram_a_webweu_tmp;
	input [7:0] ox_wr_ram_a_weawel_tmp;
	input [63:0] ox_wr_ram_a_diadi_tmp;
	input [7:0] ox_wr_ram_a_dipadip_tmp;
	input [15:0] ox_wr_ram_a_addrbrdaddr_tmp;
	input [15:0] ox_wr_ram_a_addrawraddr_tmp;
	...
	begin
		...
		1, 2, 4 : begin
		              if (!(ox_wr_ram_a_weawel_tmp[0] === 1'b1 && ox_wr_ram_a_webweu_tmp[0] === 1'b1 && a_width > b_width) || ox_wr_ram_a_seq == 2'b10) begin				  
				  if (a_width >= width)
				      task_ram_ox (ox_wr_ram_a_webweu_tmp[0], ox_wr_ram_a_weawel_tmp[0], ox_wr_ram_a_diadi_tmp[a_width-1:0], 1'b0, mem[ox_wr_ram_a_addrawraddr_tmp[14:addrawraddr_lbit_124]], tmp1);
				  else
				      task_ram_ox (ox_wr_ram_a_webweu_tmp[0], ox_wr_ram_a_weawel_tmp[0], ox_wr_ram_a_diadi_tmp[a_width-1:0], 1'b0, mem[ox_wr_ram_a_addrawraddr_tmp[14:addrawraddr_bit_124+1]][(ox_wr_ram_a_addrawraddr_tmp[addrawraddr_bit_124:addrawraddr_lbit_124] * a_width) +: a_width], tmp1);				      

				  if (ox_wr_ram_a_seq == 2'b00)
				      chk_for_col_msg (ox_wr_ram_a_weawel_tmp[0], ox_wr_ram_a_webweu_tmp[0], ox_wr_ram_a_addrawraddr_tmp, ox_wr_ram_a_addrbrdaddr_tmp);
		  
			      end // if (!(ox_wr_ram_a_weawel_tmp[0] === 1'b1 && ox_wr_ram_a_webweu_tmp[0] === 1'b1 && a_width > b_width) || ox_wr_ram_a_seq == 2'b10)
		          end // case: 1, 2, 4
		8 : begin
		        if (!(ox_wr_ram_a_weawel_tmp[0] === 1'b1 && ox_wr_ram_a_webweu_tmp[0] === 1'b1 && a_width > b_width) || ox_wr_ram_a_seq == 2'b10) begin				  
			    if (a_width >= width)
				task_ram_ox (ox_wr_ram_a_webweu_tmp[0], ox_wr_ram_a_weawel_tmp[0], ox_wr_ram_a_diadi_tmp[7:0], ox_wr_ram_a_dipadip_tmp[0], mem[ox_wr_ram_a_addrawraddr_tmp[14:3]], memp[ox_wr_ram_a_addrawraddr_tmp[14:3]]);
			    else
				task_ram_ox (ox_wr_ram_a_webweu_tmp[0], ox_wr_ram_a_weawel_tmp[0], ox_wr_ram_a_diadi_tmp[7:0], ox_wr_ram_a_dipadip_tmp[0], mem[ox_wr_ram_a_addrawraddr_tmp[14:addrawraddr_bit_8+1]][(ox_wr_ram_a_addrawraddr_tmp[addrawraddr_bit_8:3] * 8) +: 8], memp[ox_wr_ram_a_addrawraddr_tmp[14:addrawraddr_bit_8+1]][(ox_wr_ram_a_addrawraddr_tmp[addrawraddr_bit_8:3] * 1) +: 1]);
		...
		16 : begin
		         if (!(ox_wr_ram_a_weawel_tmp[0] === 1'b1 && ox_wr_ram_a_webweu_tmp[0] === 1'b1 && a_width > b_width) || ox_wr_ram_a_seq == 2'b10) begin				  
			     if (a_width >= width)
				 task_ram_ox (ox_wr_ram_a_webweu_tmp[0], ox_wr_ram_a_weawel_tmp[0], ox_wr_ram_a_diadi_tmp[7:0], ox_wr_ram_a_dipadip_tmp[0], mem[ox_wr_ram_a_addrawraddr_tmp[14:4]][0 +: 8], memp[ox_wr_ram_a_addrawraddr_tmp[14:4]][0]);
			     else
				 task_ram_ox (ox_wr_ram_a_webweu_tmp[0], ox_wr_ram_a_weawel_tmp[0], ox_wr_ram_a_diadi_tmp[7:0], ox_wr_ram_a_dipadip_tmp[0], mem[ox_wr_ram_a_addrawraddr_tmp[14:addrawraddr_bit_16+1]][(ox_wr_ram_a_addrawraddr_tmp[addrawraddr_bit_16:4] * 16) +: 8], memp[ox_wr_ram_a_addrawraddr_tmp[14:addrawraddr_bit_16+1]][(ox_wr_ram_a_addrawraddr_tmp[addrawraddr_bit_16:4] * 2) +: 1]);				     
			     
			     if (ox_wr_ram_a_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_a_weawel_tmp[0], ox_wr_ram_a_webweu_tmp[0], ox_wr_ram_a_addrawraddr_tmp, ox_wr_ram_a_addrbrdaddr_tmp);

			     if (a_width >= width)
				     task_ram_ox (ox_wr_ram_a_webweu_tmp[1], ox_wr_ram_a_weawel_tmp[1], ox_wr_ram_a_diadi_tmp[15:8], ox_wr_ram_a_dipadip_tmp[1], mem[ox_wr_ram_a_addrawraddr_tmp[14:4]][8 +: 8], memp[ox_wr_ram_a_addrawraddr_tmp[14:4]][1]);
			     else
				 task_ram_ox (ox_wr_ram_a_webweu_tmp[1], ox_wr_ram_a_weawel_tmp[1], ox_wr_ram_a_diadi_tmp[15:8], ox_wr_ram_a_dipadip_tmp[1], mem[ox_wr_ram_a_addrawraddr_tmp[14:addrawraddr_bit_16+1]][((ox_wr_ram_a_addrawraddr_tmp[addrawraddr_bit_16:4] * 16) + 8) +: 8], memp[ox_wr_ram_a_addrawraddr_tmp[14:addrawraddr_bit_16+1]][((ox_wr_ram_a_addrawraddr_tmp[addrawraddr_bit_16:4] * 2) + 1) +: 1]);

			     if (ox_wr_ram_a_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_a_weawel_tmp[1], ox_wr_ram_a_webweu_tmp[1], ox_wr_ram_a_addrawraddr_tmp, ox_wr_ram_a_addrbrdaddr_tmp);
			     
			 end // if (a_width <= b_width)
		     end // case: 16
		32 : begin
		         if (!(ox_wr_ram_a_weawel_tmp[0] === 1'b1 && ox_wr_ram_a_webweu_tmp[0] === 1'b1 && a_width > b_width) || ox_wr_ram_a_seq == 2'b10) begin				  
			     task_ram_ox (ox_wr_ram_a_webweu_tmp[0], ox_wr_ram_a_weawel_tmp[0], ox_wr_ram_a_diadi_tmp[7:0], ox_wr_ram_a_dipadip_tmp[0], mem[ox_wr_ram_a_addrawraddr_tmp[14:5]][0 +: 8], memp[ox_wr_ram_a_addrawraddr_tmp[14:5]][0]);
			     if (ox_wr_ram_a_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_a_weawel_tmp[0], ox_wr_ram_a_webweu_tmp[0], ox_wr_ram_a_addrawraddr_tmp, ox_wr_ram_a_addrbrdaddr_tmp);
			     
			     task_ram_ox (ox_wr_ram_a_webweu_tmp[1], ox_wr_ram_a_weawel_tmp[1], ox_wr_ram_a_diadi_tmp[15:8], ox_wr_ram_a_dipadip_tmp[1], mem[ox_wr_ram_a_addrawraddr_tmp[14:5]][8 +: 8], memp[ox_wr_ram_a_addrawraddr_tmp[14:5]][1]);
			     if (ox_wr_ram_a_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_a_weawel_tmp[1], ox_wr_ram_a_webweu_tmp[1], ox_wr_ram_a_addrawraddr_tmp, ox_wr_ram_a_addrbrdaddr_tmp);

			     task_ram_ox (ox_wr_ram_a_webweu_tmp[2], ox_wr_ram_a_weawel_tmp[2], ox_wr_ram_a_diadi_tmp[23:16], ox_wr_ram_a_dipadip_tmp[2], mem[ox_wr_ram_a_addrawraddr_tmp[14:5]][16 +: 8], memp[ox_wr_ram_a_addrawraddr_tmp[14:5]][2]);
			     if (ox_wr_ram_a_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_a_weawel_tmp[2], ox_wr_ram_a_webweu_tmp[2], ox_wr_ram_a_addrawraddr_tmp, ox_wr_ram_a_addrbrdaddr_tmp);
			     
			     task_ram_ox (ox_wr_ram_a_webweu_tmp[3], ox_wr_ram_a_weawel_tmp[3], ox_wr_ram_a_diadi_tmp[31:24], ox_wr_ram_a_dipadip_tmp[3], mem[ox_wr_ram_a_addrawraddr_tmp[14:5]][24 +: 8], memp[ox_wr_ram_a_addrawraddr_tmp[14:5]][3]);
			     if (ox_wr_ram_a_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_a_weawel_tmp[3], ox_wr_ram_a_webweu_tmp[3], ox_wr_ram_a_addrawraddr_tmp, ox_wr_ram_a_addrbrdaddr_tmp);
	...
	input [7:0] ox_wr_ram_b_weawel_tmp;
	input [7:0] ox_wr_ram_b_webweu_tmp;
	input [63:0] ox_wr_ram_b_dibdi_tmp;
	input [7:0] ox_wr_ram_b_dipbdip_tmp;
	input [15:0] ox_wr_ram_b_addrawraddr_tmp;
	input [15:0] ox_wr_ram_b_addrbrdaddr_tmp;
	...
	begin
		...
		1, 2, 4 : begin
		              if (!(ox_wr_ram_b_weawel_tmp[0] === 1'b1 && ox_wr_ram_b_webweu_tmp[0] === 1'b1 && b_width > a_width) || ox_wr_ram_b_seq == 2'b10) begin				  
				  if (b_width >= width)
				      task_ram_ox (ox_wr_ram_b_weawel_tmp[0], ox_wr_ram_b_webweu_tmp[0], ox_wr_ram_b_dibdi_tmp[b_width-1:0], 1'b0, mem[ox_wr_ram_b_addrbrdaddr_tmp[14:addrbrdaddr_lbit_124]], tmp1);
				  else
				      task_ram_ox (ox_wr_ram_b_weawel_tmp[0], ox_wr_ram_b_webweu_tmp[0], ox_wr_ram_b_dibdi_tmp[b_width-1:0], 1'b0, mem[ox_wr_ram_b_addrbrdaddr_tmp[14:addrbrdaddr_bit_124+1]][(ox_wr_ram_b_addrbrdaddr_tmp[addrbrdaddr_bit_124:addrbrdaddr_lbit_124] * b_width) +: b_width], tmp1);				      
				  
				  if (ox_wr_ram_b_seq == 2'b00)
				      chk_for_col_msg (ox_wr_ram_b_weawel_tmp[0], ox_wr_ram_b_webweu_tmp[0], ox_wr_ram_b_addrawraddr_tmp, ox_wr_ram_b_addrbrdaddr_tmp);
		...
		8 : begin
       	                if (!(ox_wr_ram_b_weawel_tmp[0] === 1'b1 && ox_wr_ram_b_webweu_tmp[0] === 1'b1 && b_width > a_width) || ox_wr_ram_b_seq == 2'b10) begin				  
			    if (b_width >= width)
				task_ram_ox (ox_wr_ram_b_weawel_tmp[0], ox_wr_ram_b_webweu_tmp[0], ox_wr_ram_b_dibdi_tmp[7:0], ox_wr_ram_b_dipbdip_tmp[0], mem[ox_wr_ram_b_addrbrdaddr_tmp[14:3]], memp[ox_wr_ram_b_addrbrdaddr_tmp[14:3]]);
			    else
				task_ram_ox (ox_wr_ram_b_weawel_tmp[0], ox_wr_ram_b_webweu_tmp[0], ox_wr_ram_b_dibdi_tmp[7:0], ox_wr_ram_b_dipbdip_tmp[0], mem[ox_wr_ram_b_addrbrdaddr_tmp[14:addrbrdaddr_bit_8+1]][(ox_wr_ram_b_addrbrdaddr_tmp[addrbrdaddr_bit_8:3] * 8) +: 8], memp[ox_wr_ram_b_addrbrdaddr_tmp[14:addrbrdaddr_bit_8+1]][(ox_wr_ram_b_addrbrdaddr_tmp[addrbrdaddr_bit_8:3] * 1) +: 1]);
		...
		16 : begin
	                 if (!(ox_wr_ram_b_weawel_tmp[0] === 1'b1 && ox_wr_ram_b_webweu_tmp[0] === 1'b1 && b_width > a_width) || ox_wr_ram_b_seq == 2'b10) begin				  
			     if (b_width >= width)
				 task_ram_ox (ox_wr_ram_b_weawel_tmp[0], ox_wr_ram_b_webweu_tmp[0], ox_wr_ram_b_dibdi_tmp[7:0], ox_wr_ram_b_dipbdip_tmp[0], mem[ox_wr_ram_b_addrbrdaddr_tmp[14:4]][0 +: 8], memp[ox_wr_ram_b_addrbrdaddr_tmp[14:4]][0:0]);
			     else
				 task_ram_ox (ox_wr_ram_b_weawel_tmp[0], ox_wr_ram_b_webweu_tmp[0], ox_wr_ram_b_dibdi_tmp[7:0], ox_wr_ram_b_dipbdip_tmp[0], mem[ox_wr_ram_b_addrbrdaddr_tmp[14:addrbrdaddr_bit_16+1]][(ox_wr_ram_b_addrbrdaddr_tmp[addrbrdaddr_bit_16:4] * 16) +: 8], memp[ox_wr_ram_b_addrbrdaddr_tmp[14:addrbrdaddr_bit_16+1]][(ox_wr_ram_b_addrbrdaddr_tmp[addrbrdaddr_bit_16:4] * 2) +: 1]);				     
			     ...
			     if (b_width >= width)
				 task_ram_ox (ox_wr_ram_b_weawel_tmp[1], ox_wr_ram_b_webweu_tmp[1], ox_wr_ram_b_dibdi_tmp[15:8], ox_wr_ram_b_dipbdip_tmp[1], mem[ox_wr_ram_b_addrbrdaddr_tmp[14:4]][8 +: 8], memp[ox_wr_ram_b_addrbrdaddr_tmp[14:4]][1:1]);
			     else
				 task_ram_ox (ox_wr_ram_b_weawel_tmp[1], ox_wr_ram_b_webweu_tmp[1], ox_wr_ram_b_dibdi_tmp[15:8], ox_wr_ram_b_dipbdip_tmp[1], mem[ox_wr_ram_b_addrbrdaddr_tmp[14:addrbrdaddr_bit_16+1]][((ox_wr_ram_b_addrbrdaddr_tmp[addrbrdaddr_bit_16:4] * 16) + 8) +: 8], memp[ox_wr_ram_b_addrbrdaddr_tmp[14:addrbrdaddr_bit_16+1]][((ox_wr_ram_b_addrbrdaddr_tmp[addrbrdaddr_bit_16:4] * 2) + 1) +: 1]);
			     
			     if (ox_wr_ram_b_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_b_weawel_tmp[1], ox_wr_ram_b_webweu_tmp[1], ox_wr_ram_b_addrawraddr_tmp, ox_wr_ram_b_addrbrdaddr_tmp);

			 end // if (!(ox_wr_ram_b_weawel_tmp[0] === 1'b1 && ox_wr_ram_b_webweu_tmp[0] === 1'b1 && b_width > a_width) || ox_wr_ram_b_seq == 2'b10)
		     end // case: 16
		32 : begin
		         if (!(ox_wr_ram_b_weawel_tmp[0] === 1'b1 && ox_wr_ram_b_webweu_tmp[0] === 1'b1 && b_width > a_width) || ox_wr_ram_b_seq == 2'b10) begin				  
			     task_ram_ox (ox_wr_ram_b_weawel_tmp[0], ox_wr_ram_b_webweu_tmp[0], ox_wr_ram_b_dibdi_tmp[7:0], ox_wr_ram_b_dipbdip_tmp[0], mem[ox_wr_ram_b_addrbrdaddr_tmp[14:5]][0 +: 8], memp[ox_wr_ram_b_addrbrdaddr_tmp[14:5]][0:0]);
			     if (ox_wr_ram_b_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_b_weawel_tmp[0], ox_wr_ram_b_webweu_tmp[0], ox_wr_ram_b_addrawraddr_tmp, ox_wr_ram_b_addrbrdaddr_tmp);

			     task_ram_ox (ox_wr_ram_b_weawel_tmp[1], ox_wr_ram_b_webweu_tmp[1], ox_wr_ram_b_dibdi_tmp[15:8], ox_wr_ram_b_dipbdip_tmp[1], mem[ox_wr_ram_b_addrbrdaddr_tmp[14:5]][8 +: 8], memp[ox_wr_ram_b_addrbrdaddr_tmp[14:5]][1:1]);
			     if (ox_wr_ram_b_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_b_weawel_tmp[1], ox_wr_ram_b_webweu_tmp[1], ox_wr_ram_b_addrawraddr_tmp, ox_wr_ram_b_addrbrdaddr_tmp);

			     task_ram_ox (ox_wr_ram_b_weawel_tmp[2], ox_wr_ram_b_webweu_tmp[2], ox_wr_ram_b_dibdi_tmp[23:16], ox_wr_ram_b_dipbdip_tmp[2], mem[ox_wr_ram_b_addrbrdaddr_tmp[14:5]][16 +: 8], memp[ox_wr_ram_b_addrbrdaddr_tmp[14:5]][2:2]);
			     if (ox_wr_ram_b_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_b_weawel_tmp[2], ox_wr_ram_b_webweu_tmp[2], ox_wr_ram_b_addrawraddr_tmp, ox_wr_ram_b_addrbrdaddr_tmp);

			     task_ram_ox (ox_wr_ram_b_weawel_tmp[3], ox_wr_ram_b_webweu_tmp[3], ox_wr_ram_b_dibdi_tmp[31:24], ox_wr_ram_b_dipbdip_tmp[3], mem[ox_wr_ram_b_addrbrdaddr_tmp[14:5]][24 +: 8], memp[ox_wr_ram_b_addrbrdaddr_tmp[14:5]][3:3]);
			     if (ox_wr_ram_b_seq == 2'b00)
				 chk_for_col_msg (ox_wr_ram_b_weawel_tmp[3], ox_wr_ram_b_webweu_tmp[3], ox_wr_ram_b_addrawraddr_tmp, ox_wr_ram_b_addrbrdaddr_tmp);
	...
	begin
		...
		if (weawel_tmp === 1'b1 && webweu_tmp === 1'b1 && col_wr_wr_msg == 1) begin
			...
			if (!(chk_ox_same_clk == 1))
		    	    $display("Address Overlap Error on RAMB16BWER : %m at simulation time %.3f ns.\nA write was requested to the overlapped address simultaneously at both port A and port B of the RAM. The contents written to the RAM at address location %h (hex) of port A and address location %h (hex) of port B are unknown.", $time/1000.0, addrawraddr_tmp, addrbrdaddr_tmp);
			...
			if (!(chk_ox_same_clk == 1))
			    $display("Address Overlap Error on RAMB16BWER : %m at simulation time %.3f ns.\nA read was performed on address %h (hex) of port B while a write was requested to the overlapped address %h (hex) of port A.  The write will be unsuccessful and the contents of the RAM at both address locations of port A and B became unknown.", $time/1000.0, addrbrdaddr_tmp, addrawraddr_tmp);	
			
		    end
		    else begin
			
			if ((wr_mode_a == 2'b01 || wr_mode_b == 2'b01) && (!(chk_col_same_clk == 1) && SIM_DEVICE == "SPARTAN6"))
  			    $display("Memory Collision Error on RAMB16BWER : %m at simulation time %.3f ns.\nA read was performed on address %h (hex) of port B while a write was requested to the same address on port A.  The write will be unsuccessful and the contents of the RAM at both address locations of port A and B became unknown.", $time/1000.0, addrbrdaddr_tmp);
			else if (wr_mode_a != 2'b01 || (viol_type == 2'b11 && wr_mode_a == 2'b01))
			    $display("Memory Collision Error on RAMB16BWER : %m at simulation time %.3f ns.\nA read was performed on address %h (hex) of port B while a write was requested to the same address on port A.  The write will be successful however the read value on port B is unknown until the next CLKB cycle.", $time/1000.0, addrbrdaddr_tmp);
			...
			if (!(chk_ox_same_clk == 1))
			    $display("Address Overlap Error on RAMB16BWER : %m at simulation time %.3f ns.\nA read was performed on address %h (hex) of port A while a write was requested to the overlapped address %h (hex) of port B.  The write will be unsuccessful and the contents of the RAM at both address locations of port A and B became unknown.", $time/1000.0, addrawraddr_tmp, addrbrdaddr_tmp);

		    end
		    else begin
			
			if ((wr_mode_a == 2'b01 || wr_mode_b == 2'b01) && (!(chk_col_same_clk == 1) && SIM_DEVICE == "SPARTAN6"))
  			    $display("Memory Collision Error on RAMB16BWER : %m at simulation time %.3f ns.\nA read was performed on address %h (hex) of port A while a write was requested to the same address on port B.  The write will be unsuccessful and the contents of the RAM at both address locations of port A and B became unknown.", $time/1000.0, addrbrdaddr_tmp);
			else if (wr_mode_b != 2'b01 || (viol_type == 2'b10 && wr_mode_b == 2'b01))
		    	    $display("Memory Collision Error on RAMB16BWER : %m at simulation time %.3f ns.\nA read was performed on address %h (hex) of port A while a write was requested to the same address on port B.  The write will be successful however the read value on port A is unknown until the next CLKA cycle.", $time/1000.0, addrawraddr_tmp);
			
		    end // else: !if(chk_ox_msg == 1)
			
		    col_wrb_rda_msg = 0;

		end // if (weawel_tmp === 1'b0 && webweu_tmp === 1'b1 && col_wrb_rda_msg == 1)
