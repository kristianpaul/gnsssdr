...
// Updated and converted to scilab by Gavrilov Artyom
//--------------------------------------------------------------------------
...
//channel = mtlb_repmat(channel, 1, settings.numberOfChannels);
...
[junk, PRNindexes] = mtlb_sort(acqResults.peakMetric, 2, 'descend');
