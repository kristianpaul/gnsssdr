...
// The code was improved by Artyom Gavrilov gnss-sdr.ru. 
// GALILEO version by gnss-sdr.ru
//--------------------------------------------------------------------------
...
exec('./include/readE1Bcode.sci');
exec('./include/makeE1BCodesTable.sci');
exec('./include/preRun.sci');
exec('./include/showChannelStatus.sci');
exec('./include/ephemeris.sci');
exec('./include/decode_gll_data.sci');
...
exec('./findPageStart.sci');

exec('./convolution_decoding/convol_encoder.sci');
exec('./convolution_decoding/convol_decoder.sci');
