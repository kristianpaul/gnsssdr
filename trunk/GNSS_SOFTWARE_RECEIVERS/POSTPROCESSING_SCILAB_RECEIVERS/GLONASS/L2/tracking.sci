...
// Initialize result structure ============================================
  ...
  settings_GLONASS_zero_channel = settings.GLONASS_L2_zero_channel;
  
  // GLONASS nominal IF:
  settings_IF = settings.IF;
  
  // GLONASS channel spacing:
  settings_IF_step = settings.L2_IF_step;
...
// Find DLL error and update code NCO -------------------------------------
        ...
        codeFreq = loopCnt_codeFreqBasis - codeNco - ...
                   (  carrFreq - (settings_IF - settings_IF_step*channel_FCH(channelNr))  ) / ...
                   ( (settings_GLONASS_zero_channel - channel_FCH(channelNr)*settings_IF_step) / ...
