...
//--------------------------------------------------------------------------
  ...
  settings.fileName             = 'E:\GLONASS_L3\old\FFF005.DAT';
  ...
  settings.GLONASS_nominal_freq = 1202.025e6;    //[Hz]
  ...
  settings.dllNoiseBandwidth    = 1.0;           //[Hz]
  settings.dllCorrelatorSpacing = 0.4;          //[chips]
