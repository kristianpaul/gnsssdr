...
void GUI_Channel::render(wxDC& dc)
{
	...
	for(lcv = 0; lcv < MAX_CHANNELS; lcv++)
	{
		...
		if(pchan->count > 2000)
		{
			...
			cn0_l2 =  icn0_2_fcn0(pchan->l2_cn0);
			w = pchan->w/4096.0;
			...
			//TODO: This crap needs to all be Antenna/Correlator 2 Info.			
			if(pchan->l2_Mode)
			{

				str3.Printf(wxT("     L2:  %2d   -------------   -----------   %5.2f   --    --------   ----------   ------"),
				(int32)pchan->l2_len,
				cn0_l2);
			}
