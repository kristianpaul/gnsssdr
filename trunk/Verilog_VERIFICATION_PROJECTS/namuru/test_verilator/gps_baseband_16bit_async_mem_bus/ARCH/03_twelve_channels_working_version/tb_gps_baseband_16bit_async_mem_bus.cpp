...
#define STATUS			0x200
#define NEW_DATA		0x202
#define TIC_COUNT_LOW		0x204
#define TIC_COUNT_HIGH		0x206
#define ACCUM_COUNT_LOW		0x208
#define ACCUM_COUNT_HIGH	0x20A
...
//=================Takuji Ebinuma code END=======================================
  ...
  wb_write(0x00000220, 0x00000000); wait_clock();//[Art] temporary commented!
